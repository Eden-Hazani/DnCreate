...
export class TutorialScreen extends Component<{ characterClass: CharacterModel, zIndex: any, pageHeight: any, changeScrollPosition: any, end: any }, TutorialScreenState>{
