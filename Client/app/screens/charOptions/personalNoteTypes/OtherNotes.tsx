...
export class OtherNotes extends Component<{ navigation: any, route: any }, OtherNotesState>{
            ...
            <View>
                {this.state.loading ? <AppActivityIndicator visible={this.state.loading} /> :
                    <View style={styles.container}>
                        <AppText textAlign={'center'} fontSize={25} color={Colors.bitterSweetRed}>General notes</AppText>
                        <AppText textAlign={'center'} fontSize={17}>These are your personal notes regarding anything that you want to remember.</AppText>
