...
export class LocationNotes extends Component<{ navigation: any, route: any }, LocationNotesState>{
    ...
    async componentDidMount() {
        const storedNotes = await AsyncStorage.getItem(`locationNotes${this.state.character._id}`)
        if (storedNotes) {
    ...
    deleteNote = async (noteToDel: string) => {
        ...
        if (storedNotes) {
            ...
            await AsyncStorage.setItem(`locationNotes${this.state.character._id}`, JSON.stringify(newNotes));
    ...
    updateNote = async (values: any) => {
        ...
        if (storedNotes) {
            ...
            await AsyncStorage.setItem(`locationNotes${this.state.character._id}`, JSON.stringify(oldNotes));
    ...
    render() {
        const imgArray = ['temple.png', 'mountain.png', 'forestII.png', 'forest.png', 'cabin.png', 'ruins.png', 'temple.png', 'cave.png']
        return (
            <View>
                {this.state.loading ? <AppActivityIndicator visible={this.state.loading} /> :
                    <View style={styles.container}>
                        <AppText textAlign={'center'} fontSize={25} color={Colors.bitterSweetRed}>Locations</AppText>
                        <AppText textAlign={'center'} fontSize={17}>These are your personal notes regarding unique locations around the world</AppText>
