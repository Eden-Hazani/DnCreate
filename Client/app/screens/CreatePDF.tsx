        ...
        if (this.state.character.background && this.state.character.modifiers && this.state.character.characterClassId && this.state.character.characterClassId.savingThrows) {
            html = `
                ...
                padding:4cm; height: 29.7cm; margin: 0 auto; overflow:hidden; margin-bottom: 0.5cm; background-image: ${sheetImage.sheet};">
                    ...
                    ${this.state.character.strength && this.state.character.strength >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 318px;">${this.state.character.strength}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 318px;">${this.state.character.strength}</p>`}
                    ${this.state.character.modifiers.strength && this.state.character.modifiers.strength >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 260px;">${this.state.character.modifiers.strength}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 260px;">${this.state.character.modifiers.strength}</p>`}
    
                    ${this.state.character.dexterity && this.state.character.dexterity >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 450px;">${this.state.character.dexterity}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 450px;">${this.state.character.dexterity}</p>`}
                    ${this.state.character.modifiers.dexterity && this.state.character.modifiers.dexterity >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 395px;">${this.state.character.modifiers.dexterity}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 395px;">${this.state.character.modifiers.dexterity}</p>`}
                    
                    ${this.state.character.constitution && this.state.character.constitution >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 582px;">${this.state.character.constitution}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 582px;">${this.state.character.constitution}</p>`}
                    ${this.state.character.modifiers.constitution && this.state.character.modifiers.constitution >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 525px;">${this.state.character.modifiers.constitution}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 525px;">${this.state.character.modifiers.constitution}</p>`}
                   
                    ${this.state.character.intelligence && this.state.character.intelligence >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 715px;">${this.state.character.intelligence}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 715px;">${this.state.character.intelligence}</p>`}
                    ${this.state.character.modifiers.intelligence && this.state.character.modifiers.intelligence >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 660px;">${this.state.character.modifiers.intelligence}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 660px;">${this.state.character.modifiers.intelligence}</p>`}
                    
                    ${this.state.character.wisdom && this.state.character.wisdom >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 847px;">${this.state.character.wisdom}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 847px;">${this.state.character.wisdom}</p>`}
                    ${this.state.character.modifiers.wisdom && this.state.character.modifiers.wisdom >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 790px;">${this.state.character.modifiers.wisdom}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 790px;">${this.state.character.modifiers.wisdom}</p>`}
                    
                    ${this.state.character.charisma && this.state.character.charisma >= 10 ? `<p style="font-size: 22px; position: absolute; left: 128px; top: 980px;">${this.state.character.charisma}</p>` : `<p style="font-size: 22px; position: absolute; left: 136px; top: 980px;">${this.state.character.charisma}</p>`}
                    ${this.state.character.modifiers.charisma && this.state.character.modifiers.charisma >= 10 ? `<p style="font-size: 30px; position: absolute; left: 138px; top: 925px;">${this.state.character.modifiers.charisma}</p>` : `<p style="font-size: 30px; position: absolute; left: 128px; top: 925px;">${this.state.character.modifiers.charisma}</p>`}
                    ...
                    <p style="font-size: 30px; position: absolute; left: 446px; top: 235px;">${this.state.character.equippedArmor && this.state.character.equippedArmor.ac}</p>
                    <p style="font-size: 30px; position: absolute; left: 550px; top: 235px;">${this.state.character.modifiers.dexterity}</p>
                    <p style="font-size: 30px; position: absolute; left: 640px; top: 235px;">${this.state.character.raceId && this.state.character.raceId.raceAbilities && this.state.character.raceId.raceAbilities.speed}</p>
