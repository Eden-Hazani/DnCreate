...
interface AddSpellAvailabilitySubClassState {
    shownSpells: any[],
    search: string,
    pickedSpells: any[]
    pickedSpellsBeforeChanges: any[]
}
export class AddSpellAvailabilitySubClass extends Component<{ closeModal: any, pickedSpells: any }, AddSpellAvailabilitySubClassState>{
            ...
            <View style={[styles.container, { backgroundColor: Colors.pageBackground, flex: 1 }]}>
                <View>
                    <View style={{ padding: 20, justifyContent: "center", alignItems: "center" }}>
                        <AppText color={Colors.berries} textAlign={'center'} fontSize={25}>Available Spells</AppText>
                        <AppText textAlign={'center'} fontSize={18}>Does this feature gives the character the ability to choose spells otherwise blocked for its class?</AppText>
                        <AppText textAlign={'center'} fontSize={18}>Here you can choose any spell from the spell book, these spells will be UNLOCKED to the character upon reaching this feature, meaning that the player will have the ability to add them in the future from the spell book.</AppText>
                    </View>
